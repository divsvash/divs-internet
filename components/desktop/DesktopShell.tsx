...
const initialWindows: WindowState[] = [
  ...
  ...desktopApps.filter((app) => app.id !== "my-computer").map((app, index) => ({ id: app.id, title: app.id === "internet" ? "Microsoft Internet Explorer — divs.internet" : app.label, icon: iconMap[app.id], isOpen: false, isMinimized: false, isMaximized: false, zIndex: 10, position: { x: 280 + index * 18, y: 85 + index * 14 }, size: app.id === "internet" ? { width: 760, height: 560 } : { width: 560, height: 410 } })),
];
